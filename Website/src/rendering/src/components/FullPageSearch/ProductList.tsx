...
const Price = (props: PriceProps): JSX.Element => {
  ...
  if (max) {
    return window.RFK.ui.html`<div className="price">
  ...
  return window.RFK.ui.html`
    <div className=${discounted ? 'price price-discounted' : 'price'}>
...
const ProductList = (props: ProductListProps): JSX.Element => {
  ...
  <ul className="product-list-container" style="width: 100%;">
    ...
    ${
      ready &&
      products.map(
        (product) => window.RFK.ui.html` <li class="product-list-item">
