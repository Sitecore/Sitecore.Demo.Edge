const SpeakersGrid = (): JSX.Element => (
  <div className="section__speakers__grid">
    <a href="/speakers/maryasada" className="section__speakers__grid__speaker">
    ...
    <a href="/speakers/martinmoore" className="section__speakers__grid__speaker">
