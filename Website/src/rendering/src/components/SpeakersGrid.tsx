...
const SpeakersGrid = (): JSX.Element => (
  <div className="section__speakers__grid">
    ...
    <Link href="/speakers/martinmoore">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/martin-moore.jpeg" alt="Matin Moore" />
    ...
    <Link href="/speakers/jacobgonzalez">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/jacob-gonzalez.jpeg" alt="Jacob Gonzalez" />
    ...
    <Link href="/speakers/edjones">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/ed-jones.jpeg" alt="Ed Jones" />
    ...
    <Link href="/speakers/sophiataylor">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/sophia-taylor.jpeg" alt="Sophia Taylor" />
    ...
    <Link href="/speakers/lixiuying">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/li-xiu-ying.jpeg" alt="Li Xiu Ying" />
    ...
    <Link href="/speakers/kategreen">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/kate-green.jpeg" alt="Kate Green" />
    ...
    <Link href="/speakers/jalenwilliams">
      <a className="section__speakers__grid__speaker">
        <img src="/data/media/img/speakers/jalen-williams.jpeg" alt="Jalen Williams" />
