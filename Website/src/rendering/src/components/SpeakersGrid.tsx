...
const SpeakersGrid = (): JSX.Element => (
  <div className="section__speakers__grid">
    ...
    <Link href="/speakers/martinmoore">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker2} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/jacobgonzalez">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker3} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/edjones">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker4} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/sophiataylor">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker5} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/lixiuying">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker6} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/kategreen">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker7} alt="Speaker" width={200} height={200} />
    ...
    <Link href="/speakers/jalenwilliams">
      <a className="section__speakers__grid__speaker">
        <Image src={speaker8} alt="Speaker" width={200} height={200} />
