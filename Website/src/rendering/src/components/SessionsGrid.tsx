    ...
    <div className="max-w-screen-2xl mx-auto box-border overflow-hidden">
      <div className="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        <div className="rounded overflow-hidden bg-white">
          <img className="w-full" src="/data/media/img/sessions/session-1.jpg" alt="Mountain" />
        ...
        <div className="rounded overflow-hidden bg-white">
          <img className="w-full" src="/data/media/img/sessions/session-2.jpg" alt="River" />
          <div className="px-6 py-4">
        ...
        <div className="rounded overflow-hidden bg-white">
          <img className="w-full" src="/data/media/img/sessions/session-3.jpg" alt="Forest" />
          <div className="px-6 py-4">
        ...
        <div className="rounded overflow-hidden bg-white">
          <img className="w-full" src="/data/media/img/sessions/session-4.jpg" alt="Forest" />
          <div className="px-6 py-4">
            <div className="font-bold text-base mb-2 h-20">
