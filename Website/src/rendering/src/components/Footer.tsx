...
<div className="footer">
    <div className="footer__content">
      ...
      <footer className="footer__content__footer">
        ...
        <ul className="footer__content__footer__col">
          <li>Workshops</li>
          <li><a href="#">PLAY workshop 1</a></li>
          <li><a href="#">PLAY workshop 2</a></li>
          <li><a href="#">PLAY workshop 3</a></li>
          <li><a href="#">PLAY workshop 4</a></li>
          <li><a href="#">PLAY workshop 5</a></li>
          <li><a href="#">PLAY workshop 6</a></li>
          <li><a href="#">PLAY workshop 7</a></li>
        </ul>
        <ul className="footer__content__footer__col">
          <li>Schedule</li>
          <li><a href="#">Key speakers</a></li>
          <li><a href="#">Event workshops</a></li>
          <li><a href="#">Event Specials</a></li>
