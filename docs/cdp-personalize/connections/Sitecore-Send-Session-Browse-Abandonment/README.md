...
8. Enter the following information:
   ...
   |-|-|-|
   |Request Method|POST||
   |Request URL|`https://api.moosend.com/v3/subscribers/ceda7fd4-df53-4e10-b6dc-8a637266d141/subscribe.json?apikey=Redacted`|Replace `Redacted` by your Sitecore Send API key.|
